...
func TestStageListRowsFitWidth(t *testing.T) {
	sl := newTestList()
...
func TestStageListDoneCollapsesTail(t *testing.T) {
	sl := newTestList()
...
func TestStageListTailWindow(t *testing.T) {
	sl := newTestList()
	sl.Start("scan", "Scanning")
...
func TestStageListFinishRemaining(t *testing.T) {
	sl := newTestList()
	sl.Start("scan", "Scanning")
