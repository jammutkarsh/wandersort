...
// unvalidated.
func TestConfigFormSavesEverySetting(t *testing.T) {
	home := t.TempDir()
	t.Setenv("HOME", home)
	...
	wantSubs := []string{"Home town", "Work town", "Group home/work photos by date only?", "Merge consecutive same-location days?"}
